...
function MessageWidget(message, canEdit){
...
*/
function getBasicDisplayTime(timeString){
...
/*	Returns the date depending on today's date
	...
	If the date is not the same year:
		<Month> <Day>, <Year>
*/
function getLogicDisplayTime(timeString){
	var locale = 'US-en';
...
*/
function getFromDisplayTime(timeString){
...
*/
function addEditableMessages(msgs, selector){
...
/*	Creates non-editable MessageWidget for all the Message objects in 
	msgs and adds them to the selector  
*/
function addDisplayMessages(msgs, selector){
	for(var i = 0; i < msgs.length; i++){
